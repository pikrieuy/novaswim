...
export const INITIAL_PRODUCTS = [
  { id:"p1", name:"Cyber Jacket Alpha",  emoji:"🧥", bg:"linear-gradient(135deg,#0d001a,#4b0082,#ff2d78)", price:649000, oldPrice:899000, sold:"2.1rb", rating:5, badgeClass:"pcb-new",  badgeText:"NEW",  cat:"outwear",  desc:"Jaket oversized edisi cyber dengan bahan nano-ripstop anti-air. Lapisan dalam fleece premium, cocok untuk semua cuaca.", bonus:[], reviews:[], flash:true, colors:["Hitam","Ungu","Merah"] },
  { id:"p2", name:"Neon Street Tee",     emoji:"👕", bg:"linear-gradient(135deg,#001a10,#004030,#00f5c8)", price:299000, oldPrice:0,      sold:"3.8rb", rating:5, badgeClass:"pcb-hot",  badgeText:"HOT",  cat:"clothing", desc:"Kaos streetwear dengan motif neon grid. Bahan katun combed 30s premium, sablon anti-crack dan anti-luntur.", bonus:[], reviews:[], flash:true, colors:["Hitam","Putih","Hijau Neon"] },
  { id:"p3", name:"Pixel Runner X",      emoji:"👟", bg:"linear-gradient(135deg,#0a0a00,#404000,#ffe500)", price:489000, oldPrice:799000, sold:"1.5rb", rating:4, badgeClass:"pcb-sale", badgeText:"-39%", cat:"shoes",    desc:"Sepatu lari edisi pixel art limited. Sol air-cushion teknologi terbaru, upper mesh breathable anti-bau.", bonus:[], reviews:[], flash:true, colors:["Kuning","Hitam"] },
  { id:"p4", name:"Dark Matter Hoodie",  emoji:"🫱", bg:"linear-gradient(135deg,#0a0000,#800020,#ff2d78)", price:549000, oldPrice:749000, sold:"987",   rating:5, badgeClass:"pcb-hot",  badgeText:"HOT",  cat:"outwear",  desc:"Hoodie premium unisex dengan bahan fleece tebal. Desain minimalis dark academia dengan logo emboss.", bonus:[], reviews:[], flash:false, colors:["Hitam","Abu-abu","Maroon"] },
  { id:"p5", name:"Aurora Cargo Pants",  emoji:"👖", bg:"linear-gradient(135deg,#001830,#003060,#00f5ff)", price:429000, oldPrice:0,      sold:"744",   rating:5, badgeClass:"pcb-new",  badgeText:"NEW",  cat:"clothing", desc:"Cargo pants futuristik dengan 8 saku fungsional. Bahan tech-fabric ringan dan tahan lama.", bonus:[], reviews:[], flash:false, colors:["Navy","Hitam","Olive"] },
  { id:"p6", name:"Hologram Bag Pro",    emoji:"👜", bg:"linear-gradient(135deg,#100020,#5500aa,#ff88ff)", price:389000, oldPrice:0,      sold:"523",   rating:4, badgeClass:"pcb-hot",  badgeText:"HOT",  cat:"accessory",desc:"Tas hologram eksklusif dengan efek shimmer 3D. Material vegan leather premium, kapasitas 20L.", bonus:[], reviews:[], flash:false, colors:["Silver","Ungu"] },
  { id:"p7", name:"Galaxy Set Bundle",   emoji:"🛍️", bg:"linear-gradient(135deg,#001030,#0066ff,#00f5ff)", price:899000, oldPrice:1299000,sold:"1.2rb", rating:5, badgeClass:"pcb-sale", badgeText:"-31%", cat:"set",      desc:"Bundle Galaxy Set: jaket + kaos + celana cargo. Hemat 400rb vs beli satuan. Edisi terbatas 2077.", bonus:[], reviews:[], flash:true, colors:["Biru Galaxy"] },
  { id:"p8", name:"Pixel Storm Sneakers",emoji:"👠", bg:"linear-gradient(135deg,#0a0020,#004080,#ff00aa)", price:559000, oldPrice:0,      sold:"631",   rating:4, badgeClass:"pcb-new",  badgeText:"NEW",  cat:"shoes",    desc:"Sneakers platform edisi pixel storm dengan sol chunky 5cm. Upper metalik futuristik, insole memory foam.", bonus:[], reviews:[], flash:false, colors:["Pink Metalik","Hitam","Putih"] },
];
